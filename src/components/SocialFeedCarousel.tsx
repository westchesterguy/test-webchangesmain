...
/**
 * The carousel itself. Client-side because the rail tracks its own scroll
 * position for the arrows; the posts are handed to it by SocialFeed, which
 * does the fetching a client component cannot.
 *
